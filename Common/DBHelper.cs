...
namespace HK.Common
{
    public class DBHelper
    {
        ...
        //连接字符串
        //static string strConn = ConfigurationManager.ConnectionStrings["Datas"].ConnectionString;
        private string server = "192.168.1.7";
        static string strConn = "Server=192.168.1.7; Database=HKAPI;User ID = sa; Password=426ruikai;MultipleActiveResultSets=true";
